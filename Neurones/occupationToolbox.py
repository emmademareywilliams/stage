...
training an agent recreating the behavior of a hysteresis controller coupled with non occupation
"""
import numpy as np
...
def modelPlayHystNnnOcc(datas, index=1, Tc=Tc, max_power=max_power):
    """
    xxx
    """
...
class Training:
    ...
    def play(self, ts=None):
        ...
        result = modelPlayHystNnnOcc(copy.deepcopy(datas), pos)
